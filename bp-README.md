...
Double-dash ligatures compress multiple boolean flags:
...
For advanced validation, default values, prefix matching, and parameter relationships, see `bp-PFILTER.md` or `doc/bp-PFILTER-GUILD.md`.
...
- Bash 4.4+
- `jq` only for JSON output or PFILTER serialization
